...
class Pref  {
  ...
  /// Get preference bool
  static
  Future<bool> getBool( String key, {bool defaultVal = true}) async {
  ...
  /// Set preference bool
  static
  Future<void> setBool(String key, {bool value = false}) async {
    final SharedPreferences prefs = await SharedPreferences.getInstance();
  ...
  /// Get preference int
  static
  Future<int> getInt(String key, int defaultVal) async {
    final SharedPreferences prefs = await SharedPreferences.getInstance();
  ...
  static
  Future<double> getDouble(String key, double defaultVal) async {
    final SharedPreferences prefs = await SharedPreferences.getInstance();
